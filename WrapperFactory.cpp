...
{
    if (handler == &CFLUME::singleton || handler == &XFLUME::singleton) {
                       ...
                       HandleObject parent)
{
    ...
    XrayType xrayType = GetXrayType(obj);
    bool originIsConfined = xpc::flume::IsCompartmentConfined(origin);
    bool targetIsConfined = xpc::flume::IsCompartmentConfined(target);
